...
public record WorldState(int day,int population,FoodStatus foodStatus,int generatorHours,PowerMode powerMode,
 ...
 public static WorldState initial(){return new WorldState(1,43,FoodStatus.FOUR_DAYS,96,PowerMode.LIMITED,WorkshopStatus.OFFLINE,2,ReactorCondition.NONE,ReactorLocation.NONE,ReactorOutput.NONE,Node12Relation.UNKNOWN,new KrotState(MachineLife.OPERATIONAL,MachineLocation.IN_FIELD,KrotActuator.WORN),new StrizhState(MachineLife.OPERATIONAL,MachineLocation.IN_FIELD,StrizhSensor.OPERATIONAL),new IglaState(MachineLife.OPERATIONAL,MachineLocation.IN_FIELD,IglaManipulator.OPERATIONAL),Set.of(),Set.of(),null,null,null,null);}
