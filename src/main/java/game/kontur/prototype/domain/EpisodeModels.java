...
public final class EpisodeModels {
 ...
 public record ChoiceOption(ChoiceId id,String intent,String price,String risk,String unknownPart){public ChoiceOption{Objects.requireNonNull(id);intent=Objects.requireNonNull(intent);price=Objects.requireNonNull(price);risk=Objects.requireNonNull(risk);unknownPart=Objects.requireNonNull(unknownPart);}}
